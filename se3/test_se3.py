...
def test_word_length_1():
    do_test_word_length(list_of_words=["hello", "bye"], 
                        expected={"hello": 5, "bye": 3})

def test_word_length_2():
    do_test_word_length(list_of_words=["hello", "bye", "hi", "a"], 
                        expected={"hello": 5, "bye": 3, "hi": 2, "a": 1})

def test_word_length_3():
    do_test_word_length(list_of_words=["what"], 
                        expected={"what": 4})

def test_word_length_4():
    do_test_word_length(list_of_words=[], 
                        expected={})
    
def test_words_start_with_1():
    do_test_words_start_with(list_of_words=["hello"], 
                             expected={"h": 1})

def test_words_start_with_2():
    do_test_words_start_with(list_of_words=["hello", "bye"], 
                             expected={"h": 1, "b": 1})

def test_words_start_with_3():
    do_test_words_start_with(list_of_words=["hello", "bye", "hi", "a"], 
                             expected={"h": 2, "b": 1, "a": 1})

def test_words_start_with_4():
    do_test_words_start_with(list_of_words=[], 
                             expected={})

def test_words_start_with_5():
    do_test_words_start_with(list_of_words=["hello", "bye", "hi", "a", "hannah", "hi", "blue", "what", "ape"], 
                             expected={"h": 4, "b": 2, "a": 2, "w": 1})

def test_num_of_new_voters_1():
    registered_voters = voters
    target = 200000
    expected = [('California', '2020', 'Feb')]
    do_test_num_of_new_voters(registered_voters, target, expected)

def test_num_of_new_voters_2():
    registered_voters = voters
    target = 150000
    expected = [('California', '2016', 'Mar'),
                ('California', '2016', 'Apr'),
                ('California', '2020', 'Jan'),
                ('California', '2020', 'Feb'),
                ('California', '2020', 'Mar'),
...
def test_num_of_new_voters_3():
    registered_voters = voters
    target = 100000
    expected = [('California', '2016', 'Feb'),
                ('California', '2016', 'Mar'),
                ('California', '2016', 'Apr'),
                ('California', '2020', 'Jan'),
                ('California', '2020', 'Feb'),
...
def test_total_registered_voters_1():
    registered_voters = voters
    month_and_year = ('Jan', '2020')
    expected = {'Arizona': '33229',
                'California': '151595',
                'Colorado': '20260',
                'Delaware': '3276',
                ...
                'Texas': '134559',
                'Virginia': '25934'}
    do_test_total_registered_voters(registered_voters, month_and_year, expected)

def test_total_registered_voters_2():
    registered_voters = voters
    month_and_year = ('Jan', '2016')
    expected = {'Arizona': '25852',
                'California': '87574',
                'Colorado': '17024',
                'Delaware': '3007',
...
def test_total_registered_voters_3():
    registered_voters = voters
    month_and_year = ('Feb', '2016')
    expected = {'Arizona': '51155',
                'California': '103377',
                'Colorado': '20707',
                'Delaware': '3629',
...
def test_new_voters_by_month_1():
    registered_voters = voters
    year = '2016'
    expected = {'Jan': ['25852','87574','17024','3007','2840','50231','34952','44040','19580','35213','132860','20032'],
    ...
    do_test_new_voters_by_month(registered_voters, year, expected)

def test_new_voters_by_month_2():
    registered_voters = voters
    year = '2020'
    expected = {'Jan': ['33229','151595','20260','3276','3334','77466','38573','44443','21532','111990','134559','25934'],
...
def do_test_word_length(list_of_words, expected):
    recreate_msg = gen_recreate_msg(MODULE, "word_length", [], *(list_of_words,))
...
def do_test_words_start_with(list_of_words, expected):
    recreate_msg = gen_recreate_msg(MODULE, "words_start_with", [], *(list_of_words,))
...
def do_test_num_of_new_voters(registered_voters, target, expected):
    recreate_msg = "To recreate this test in ipython3 run:\n"
...
def do_test_total_registered_voters(registered_voters, month_and_year, expected):
    recreate_msg = "To recreate this test in ipython3 run:\n"
    recreate_msg += "  voters = test_helpers.read_CSV_file('tests/new_voter_registrations)\n"
...
def do_test_new_voters_by_month(registered_voters, year, expected):
    recreate_msg = "To recreate this test in ipython3 run:\n"
    recreate_msg += "  voters = test_helpers.read_CSV_file('tests/new_voter_registrations)\n"
